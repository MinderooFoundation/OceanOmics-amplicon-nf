process VSEARCH_USEARCHGLOBAL {
    ...
    """
    vsearch --usearch_global ${reads} --db ${db} ${args} --otutabout zotu_table.tsv

    # Vsearch usearch_global can cut off parts of sample names (e.g., if the sample name contains a '-')
