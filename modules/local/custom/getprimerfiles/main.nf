process GET_PRIMERFILES {
    ...
    if [[ \${fw_prim} == *";"* ]]; then
        ...
        do
            fw_primer_rvcomp=\$(echo \${fw_primer_arr[\$i]} | rev | sed 's/C/g/g' | sed 's/G/c/g' | sed 's/T/a/g' | sed 's/A/t/g' | sed 's/g/G/g' | sed 's/c/C/g' | sed 's/a/A/g' | sed 's/t/T/g')
    ...
    if [[ \${rv_prim} == *";"* ]]; then
        ...
        do
            rv_primer_rvcomp=\$(echo \${rv_primer_arr[\$i]} | rev | sed 's/C/g/g' | sed 's/G/c/g' | sed 's/T/a/g' | sed 's/A/t/g' | sed 's/g/G/g' | sed 's/c/C/g' | sed 's/a/A/g' | sed 's/t/T/g')
